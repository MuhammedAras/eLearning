...
{
    public class LearningAuthorizeAttribute : ForceHttpsAttribute
    {
        [Inject]
        ...
        {
            //Kullanıcının forms authentication kullanılarak doğrulanması durumunda
            //basic authentication için Header'ı kontrol etmeye gerek yoktur.
        ...
        private void HandleUnauthorizedRequest(System.Web.Http.Controllers.HttpActionContext actionContext)
        {
            ...
            "Basic Scheme='eLearning' location='http://localhost:33194/account/login'");
